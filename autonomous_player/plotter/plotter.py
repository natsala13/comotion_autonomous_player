...
def plot_dijkestra_path(paths: list, show: bool = True, color='r'):
    ...
    plt.scatter(paths[0][0], paths[0][1], marker='o', c=color)
    plt.scatter(paths[-1][0], paths[-1][1], marker='X', c=color)
